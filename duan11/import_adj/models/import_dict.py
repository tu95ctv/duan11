...
#                     ('start_width', {'required':True, 'for_excel_readonly':True, 'func': lambda v,n,self: n['vof_dict']['id_char']['val'].startswith(app) and ',' not in n['vof_dict']['modules']['val']}),
            ...
            u'action_import': {
                ...
                'fields' : [
                    ...
                    ('usage', {'xl_title':u'usage', 'required':False, 'key':True , 'allow_not_match_xl_title':True }),
                    ('auto_search', {'xl_title':u'auto_search', 'required':False, 'key':True,  'allow_not_match_xl_title':True  }),
                    ...
                    ('res_id', {'xl_title':u'res_id', 'required':False, 'key':True, 'allow_not_match_xl_title':True}),
                    ('multi', {'xl_title':u'multi', 'required':False, 'key':True , 'allow_not_match_xl_title':True }),
                    ...
                    ('view_id', {'xl_title':u'view_id/id', 'required':False, 'write_false':True ,'func': lambda v,n,self: '' if not v else v }),
                    ('search_view_id', {'xl_title':u'search_view_id/id', 'required':False, 'write_false':True, 'func': lambda v,n,self: '' if not v else v }),
                      ]
                },#End stock.inventory.line'   
